...
void ReadMatrix(int A[][SIZE],int N)
{
    int i,j;
...
void MatrixAdd(int A[][SIZE], int B[][SIZE], int Result[][SIZE], int N)
{
    int i, j;
...
void MatrixSubtrac(int A[][SIZE], int B[][SIZE], int Result[][SIZE], int N)
{
    int i, j;
...
void StrassenAlgorithm(int A[][SIZE], int B[][SIZE], int C[][SIZE], int N)
{
...
int main()
{
    ...
    printf("What Is The Dimension: ");
    scanf("%d",&N);

    while (N >= SIZE)
    {
        std::cout << "The dimension should be smaller than: " << SIZE << std::endl;
        printf("What Is The Dimension: ");
        scanf("%d",&N); 
    }
    M = N;
