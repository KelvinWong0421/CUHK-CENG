...
void cycle_memory() {
    ...
    if (mio_en) {
        ...
        if (W) {
            ...
            case -3:
                MEM_VAL =
                    sext_unit(MASK7_0(MEMORY[CURRENT_LATCHES.MAR]), 32) +
                    (sext_unit(MASK7_0(MEMORY[CURRENT_LATCHES.MAR + 1]), 32) << 8) +
                    (sext_unit(MASK7_0(MEMORY[CURRENT_LATCHES.MAR + 2]), 32) << 16) +
                    (sext_unit(MASK7_0(MEMORY[CURRENT_LATCHES.MAR + 3]), 32) << 24) ;
                break;
            case -2:
                MEM_VAL = 
                    sext_unit(MASK7_0(MEMORY[CURRENT_LATCHES.MAR]), 32) +
